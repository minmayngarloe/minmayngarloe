...
<html class="loading">
  ...
  <div class="content-body">
    ...
    <option </option>
				...
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/inr1cvv.php">Stripe Charge CVV: ₹100</option>
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/inr1cnn.php">Stripe Charge CCN: ₹100</option>
