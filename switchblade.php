...
$botToken = "5665446643:AAGbsNiw2vH0UlFbDuDYkYohRJ9WdnQBBBM"; #<------------------- PUT YOUR TOKEN HERE------------->#
...
// Proxy Configuration
$rp1 = array(
    1 => 'vppxhfxr:mcm7xekn5jlr',
    2 => 'fkeeglqk:g2zjzpx4w6ti',
    3 => 'iuzcrmoi:ppc7gz44nooa',
    4 => 'sobszakg:yoftpa2llxx2',
    5 => 'peikpezr:u3rg6yzewomz',
    ); 
    $rpt = array_rand($rp1);
    $rotate = $rp1[$rpt];
